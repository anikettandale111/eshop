...
@section('meta_title', get_settings('site_title') . ' || FAQ')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 d-none d-md-block">
                    <div class="nav flex-column nav-pills sidebar-tabs" id="v-pills-tab" role="tablist"
                        ...
                        <h6 class="nav-link font-weight-bold">FAQ</h6>
                        ...
                        <a class="nav-link active" id="faq-tab" data-toggle="pill" href="#faq-content" role="tab"
