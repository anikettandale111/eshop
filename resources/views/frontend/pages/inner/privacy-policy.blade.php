...
@section('meta_title', get_settings('site_title') . ' || Privacy Policy')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 d-none d-md-block">
                    <div class="nav flex-column nav-pills sidebar-tabs" id="v-pills-tab" role="tablist"
                        ...
                        <h6 class="nav-link font-weight-bold">Privacy Policy</h6>
                        ...
                        <a class="nav-link active" id="privacy-tab" data-toggle="pill" href="#privacy-content"
                            role="tab" aria-controls="privacy-content" aria-selected="false">Privacy Policy</a>
