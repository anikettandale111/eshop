...
@section('meta_title', get_settings('site_title') . ' || About us')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 d-none d-md-block">
                    <div class="nav flex-column nav-pills sidebar-tabs" id="v-pills-tab" role="tablist"
                        ...
                        <h6 class="nav-link font-weight-bold">About Us</h6>
                        <a class="nav-link active" id="about-us-tab" data-toggle="pill" href="#about-us-content"
                            role="tab" aria-controls="about-us-content" aria-selected="true">About
                            {{ env('APP_NAME') }}</a>
                        ...
                        <a class="nav-link" id="terms-tab" data-toggle="pill" href="#terms-content" role="tab"
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="tab-content sidebar-tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="about-us-content" role="tabpanel"
                            aria-labelledby="about-us-tab">
                            <h1 class="title">About {{ env('APP_NAME') }}</h1>
                            ...
                            <div class="faq-accordion mt-3 mb-5">
                                <ul class="accordion">
                                    @if (\App\Models\FAQ::where('status', 'active')->count() > 0)
                                        @foreach (\App\Models\FAQ::where('status', 'active')->orderBy('id', 'DESC')->get() as $key => $item)
