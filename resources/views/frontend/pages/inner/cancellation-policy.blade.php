...
@section('meta_title', get_settings('site_title') . ' || Cancellation Policy')
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-3 d-none d-md-block">
                    <div class="nav flex-column nav-pills sidebar-tabs" id="v-pills-tab" role="tablist"
                        ...
                        <h6 class="nav-link font-weight-bold">Cancellation Policy</h6>
                        ...
                        <a class="nav-link active" id="cancellation-tab" data-toggle="pill" href="#cancellation-content"
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="tab-content sidebar-tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade  show active" id="cancellation-content" role="tabpanel"
